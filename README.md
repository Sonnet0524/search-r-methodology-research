...
**search-r-methodology-research 使用 SEARCH-R 方法论来研究 SEARCH-R 方法论本身**，形成方法论的自举（Bootstrap）和持续迭代优化。
...
│   ┌──────────────────────────────────────────────┐                  │
│   │  方法论研究仓库                                │                  │
│   │  ├── research/theory/    (理论成果)           │                  │
│   │  ├── research/observations/ (研究发现)        │                  │
│   │  ├── research/reflections/ (方法反思)         │                  │
│   │  └── sync-logs/          (同步记录)           │                  │
│   └──────────────────────────────────────────────┘                  │
│                                                                      │
└─────────────────────────────────────────────────────────────────────┘
...
#### 1. SEARCH-R → search-r-methodology-research（方法论输入）

| 输入内容 | 来源目录 | 用途 |
|---------|---------|------|
| 方法论定义 | `methodology/` | 研究对象：SEARCH-R循环、深度标准、Human角色 |
| 业务能力 | `skills/` | 研究工具：文献检索、观察记录、理论构建、质量门控 |
| 底层工具 | `tools/` | 研究支撑：百度搜索、学术检索、OCR处理 |
| 文档模板 | `templates/` | 研究输出：标准化的文档格式 |

#### 2. search-r-methodology-research → SEARCH-R（研究产出）

| 产出内容 | 来源目录 | 影响 |
|---------|---------|------|
| 理论成果 | `research/theory/` | 深化方法论理论基础 |
| 实践发现 | `research/observations/` | 发现方法论改进点 |
| 方法反思 | `research/reflections/` | 优化方法论设计 |
| 最佳实践 | `sync-logs/` | 沉淀可复用经验 |
...
│  2. 发现阶段                                                 │
│     发现方法论的问题和改进机会                               │
│     记录到 observations/ 和 reflections/                    │
│          ↓                                                   │
│  3. 研究阶段                                                 │
│     深入研究改进方案                                         │
│     产出理论成果到 theory/                                   │
...
| 迭代 | 时间 | 研究内容 | 对SEARCH-R的影响 |
|:----:|------|---------|-----------------|
| v1.0 | 2026-03-07 | 核心理论构建 | 建立方法论框架 |
| v1.1 | 2026-03-08 | 文档体系设计 | 完善模板标准 |
| v1.2 | 2026-03-09 | 课题定位研究 | 明确架构层级 |
| v2.0 | 2026-03-14 | Skills/Tools重构 | 分离业务能力和底层工具 |
